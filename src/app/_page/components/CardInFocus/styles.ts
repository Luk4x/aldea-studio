...
export const cardInFocusStyles = tv({
  slots: {
    ...
    container:
      'flex h-[calc(100%-3.6875rem)] w-full flex-col overflow-hidden rounded-[1.25rem] border border-neutral-900/[8%] bg-neutral-50 shadow-[0_2px_3px_0_rgba(20,27,52,0.06)]',
    header: 'flex flex-shrink-0 items-center justify-between p-6',
    cancelButton: 'cursor-pointer',
    icon: 'opacity-[52%]',
    moreHorizontalIcon: 'opacity-[54%]',
    scrollableContent: 'flex-1 overflow-y-auto pb-4 hide-scroll',
    ...
    textarea: 'mx-auto mb-5 max-w-[46.25rem]',
    textareaContainer: 'flex-shrink-0 max-lg:px-[1.25rem]',
  },
});
