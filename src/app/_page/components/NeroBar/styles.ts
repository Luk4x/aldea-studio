...
export const neroBarStyles = tv({
  slots: {
    overlay:
      'fixed bottom-0 flex h-[16.25rem] w-screen items-end justify-center bg-gradient-to-b from-neutral-150/0 to-neutral-150/100',
    container:
      'mb-5 flex h-[3.75rem] w-[12.1875rem] cursor-pointer items-center justify-center gap-1.5 rounded-full border border-neutral-900/[8%] bg-neutral-150 shadow-[0_2px_3px_0_rgba(20,27,52,0.06)] transition-all duration-300 ease-in-out sm:mb-[1.875rem]',
    audio:
